...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,8100,8090,8187,8188,8190,8200,8902,9112,8903,8904,9113,8000,8001,8003,8005,%GameFilterTCP% --wf-udp=443,19294-19344,20001-21000,50000-50100,%GameFilterUDP% ^
--wf-raw-part="@%~dp0windivert.filter\windivert_part.customgame.txt" ^
--filter-tcp=8090,8100,8187,8188,8190,8200,8902,9112,8903,8904,9113,8000,8001,8003,8005 --dpi-desync=syndata --dpi-desync-fake-syndata="%BIN%tls_clienthello_4pda_to.bin" --new ^
